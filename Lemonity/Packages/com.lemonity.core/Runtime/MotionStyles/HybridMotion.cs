...
namespace Lemonity.Core
{
	public class HybridMotion : IMotionStyle
	{
		...
		public HybridMotion(Runtime runtime, TrackingSpaceOptions trackingSpaceOptions, CameraOptions cameraOptions, GrabModeOptions grabModeOptions, InertiaOptions inertiaOptions)
		{
				_oneMotion = new OneHandMotion(runtime, trackingSpaceOptions, cameraOptions, grabModeOptions, inertiaOptions);
			_oneMotion.LeftGesture = LeftGesture;
			_oneMotion.RightGesture = RightGesture;
			_oneMotion.OptionsChange();

				_twoMotion = new TwoHandsMotion(runtime, trackingSpaceOptions, cameraOptions, grabModeOptions, inertiaOptions);
