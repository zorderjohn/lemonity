...
namespace Lemonity.Core
{
	public class TwoHandsMotion : MotionStyleBase
	{
		...
		public TwoHandsMotion(Runtime runtime, TrackingSpaceOptions trackingSpaceOptions, CameraOptions cameraOptions, GrabModeOptions grabModeOptions, InertiaOptions inertiaOptions)
		...
		protected override void UpdateMotion()
		{
			...
			eulerYawDeltaRot.Scale(_trackingSpaceOptions.AxisRotScale);
			eulerYawDeltaRot *= _grabModeOptions.RotScale;
			...
			Vector3 ccDeltaTranslation = (_hcCenterInitialPos - hcCenterFinalPos) * _trackingSpaceOptions.PosScale;
		...
		{
#if UNITY_EDITOR
			var wcLeftInitialPos = LeftGesture.ObjectInitialPosition + LeftGesture.ObjectInitialRotation * HandTracking.HandToCamCoordinates(LeftGesture.HandInitialPosition, _trackingSpaceOptions);
			var wcRightInitialPos = LeftGesture.ObjectInitialPosition + LeftGesture.ObjectInitialRotation * HandTracking.HandToCamCoordinates(RightGesture.HandInitialPosition, _trackingSpaceOptions);
