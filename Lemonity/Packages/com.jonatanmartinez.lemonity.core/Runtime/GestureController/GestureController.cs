...
namespace Lemonity.Core
{
	...
	public abstract class GestureControllerBase : IGestureController
	{
		...
		protected GestureControllerBase(GestureOptions gestureOptions, HeuristicOptions heuristicOptions)
		{
			_gestureOptions = gestureOptions;
			_heuristicOptions = heuristicOptions;
			Heuristic = HeuristicState.AllowAll;
			IsHolding = false;
		}

		protected GestureOptions GestureOptions
		{
			get { return _gestureOptions; }
		}
		...
		protected virtual HeuristicState HeuristicCondition()
		{
			...
			bool isNear = distanceToCenter < _heuristicOptions.Radius;
